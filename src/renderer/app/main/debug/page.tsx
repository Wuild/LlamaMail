				...
				<div className="min-h-0 flex-1 overflow-hidden p-3">
					<div className="flex h-full min-h-0 flex-col gap-3">
						<header className="debug-card rounded-xl p-4">
							<div className="flex flex-wrap items-start justify-between gap-3">
								...
								<div className="flex items-center gap-2">
									<label className="debug-card debug-muted inline-flex items-center gap-2 rounded-md px-2.5 py-1.5 text-xs">
										<FormCheckbox
											checked={autoScroll}
											onChange={(event) => {
						...
						<main className="min-h-0 flex-1">
							<div className="debug-log-shell flex h-full min-h-0 flex-col overflow-hidden rounded-xl select-text">
								<div
									ref={listRef}
