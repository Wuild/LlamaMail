	...
	return (
		<>
			...
			{!loading && attachments.length > 0 && (
				<div className="shrink-0 border-t ui-border-default bg-[color-mix(in_srgb,var(--surface-content)_80%,transparent)] px-4 py-3">
					<div className="overflow-x-auto overflow-y-hidden">
						<div className="flex min-w-full w-max gap-2 pb-1">
							{attachments.map((attachment, index) => (
								...
								>
									<span className="attachment-icon flex h-10 w-10 shrink-0 items-center justify-center rounded-md border ui-border-default ui-text-muted">
										<Paperclip size={15} />
									</span>
